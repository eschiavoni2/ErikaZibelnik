    ...
    return(
      <div>
        <h1 style={{textAlign: 'center'}}>About Me</h1>
          {/* Project 1 */}
          <Card className="width" shadow={5} style={{margin: 'auto'}}>
            <CardTitle style={{color: '#fff', height: '600px', background: 'url(../assets/images/Charlie.jpg) center / cover'}} >Erika Zibelnik</CardTitle>
            <CardText>
              Erika Zibelnik is a former Biologist that moved to Florida and decided for a career path change. She's able to adapt quickly, and come up with ideas that fill spaces. One project she is working on is due to a gap she saw while working as a former Vet Tech. 
              <br />
              <br />
